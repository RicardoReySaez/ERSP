...
available in \texttt{BayesianEFA} package, which can be installed from
\url{https://github.com/RicardoReySaez/BayesianEFA}.  The authors
declare that they have no conflict of interest. This work was supported
by the Spanish Ministry of Science and Innovation grants
PID2023-150830NB-I00 (to RRS) and PID2021-124885NB-I00 (to JR).   Author
...
package \texttt{BayesianEFA} (\citeproc{ref-BayesianEFA}{Rey-Sáez,
2026}).
...
\texttt{R} package \texttt{BayesianEFA}. In Study 1, we compared E-RSP
...
through the open-source R package \texttt{BayesianEFA}. Because it
requires only posterior draws of the loading matrix as input, E-RSP can
be integrated straightforwardly into existing Bayesian factor model
...
\bibitem[\citeproctext]{ref-BayesianEFA}
Rey-Sáez, R. (2026). \emph{BayesianEFA: Bayesian exploratory factor
analysis using 'stan'}.
\url{https://ricardoreysaez.github.io/BayesianEFA/}
